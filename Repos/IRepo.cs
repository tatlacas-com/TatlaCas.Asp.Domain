...
namespace TatlaCas.Asp.Domain.Repos
{
    public interface IRepo<TEntity, TResource> where TEntity : IEntity where TResource : IResource
    {
        ...
        Task<List<TEntity>> EntitiesWhereAsync(Expression<Func<TEntity, bool>> queryExpr, int pageSize = -1,
            int page = 0, List<string> includeRelationships = null);
        ...
        Task<List<TResource>> ResourcesAsync(int pageSize = -1,
            int page = 0, List<string> includeRelationships = null);
